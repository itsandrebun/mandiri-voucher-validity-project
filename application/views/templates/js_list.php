...
<script src="<?php echo base_url() . 'assets/js/inputmask/inputmask.date.extensions.js';?>"></script>
<script src="<?php echo base_url() . 'assets/js/inputmask/inputmask.numeric.extensions.js';?>"></script>
