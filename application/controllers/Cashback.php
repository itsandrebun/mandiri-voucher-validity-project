    ...
    private function submit_master_cashback(){
    	...
    	if($this->form_validation->run() === FALSE){
    		...
    		$cashback_master = array(
	    		...
	    		'total_quota' => ($this->input->post('extra_quota') != null ? ($this->input->post('total_quota') + $this->input->post('extra_quota')) : $this->input->post('total_quota')),
	    		'available_quota' => ($this->input->post('extra_quota') != null ? ($this->input->post('total_quota') + $this->input->post('extra_quota')) : $this->input->post('total_quota')),
	    	...
	    	if($this->input->post('id') != null && $this->input->post('id') != ""){
	    		...
	    		if($cashback_master['available_quota'] != "" && $cashback_master['available_quota'] != null){
	    			$cashback_master['available_quota'] = ($this->input->post('extra_quota') != null ? ($this->input->post('total_quota') + $this->input->post('extra_quota')) : $this->input->post('total_quota')) - $sold_quota;
	    		}
